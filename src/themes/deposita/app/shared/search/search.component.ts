...
import { SearchConfigurationOption } from 'src/app/shared/search/search-switch-configuration/search-configuration-option.model';
...
import { SelectionConfig } from 'src/app/shared/search/search-results/search-results.component';
...
import { ITEM_MODULE_PATH } from 'src/app/item-page/item-page-routing-paths';
import { COLLECTION_MODULE_PATH } from 'src/app/collection-page/collection-page-routing-paths';
import { COMMUNITY_MODULE_PATH } from 'src/app/community-page/community-page-routing-paths';
...
export class SearchComponent implements OnInit {
  ...
  onFilterChange(selectedValue: string): void {
    const typeMap = {
      'Artigos': 'Article',
      'Artigos_de_conferencia': 'Conference',
      'Livros': 'Book',
      'Capitulo_de_livro': 'Book_part',
      'Tcc': 'Trabalho_de_conclusao_de_curso',
      'Teses': 'Thesis',
      'Dissertacoes': 'Dissertação'
    };
